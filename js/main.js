...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to leeharkness.com",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "welcome_message.txt":"Welcome to leeharkness.com",
        "about.txt": "Lee Harkness is a guy who writes software, takes pictures, and sometimes writes stories.\nMost of the content found here, or linked to from here, will be out of date because Lee Harkness is terrible at time management.\nBut perhaps this site will serve as all the impetus he needs to rectify that.",
        "programming.txt": "Lee Harkness has been programming for a while now.  For some examples of his work, head over to https://lharkness.github.io/ and for his ideas on stuff, check out http://developerlee.wordpress.com \n direct links on the sidebar",
        "photography.txt": "Lee Harkness has been taking pictures for a while now.  For pictures, check out flickr at https://flickr.com/photos/lharkness and for a photo blog go to https://roadsidefruitstand.wordpress.com",
        "contact.txt": "lee@leeharkness.com",
        "github.txt": "https://lharkness.github.io/",
        "developerlee.txt": "https://developerlee.wordpress.com/",
        "photos.txt":"https://flickr.com/photos/lharkness",
        "photoblog.txt":"https://roadsidefruitstand.wordpress.com/"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
